...
# import poisson
from dataloaders import poisson
...
def generate_possion_dis(num_points, min, max):
    ...
    iterations_per_point = 256  # iterations per point trying to look for a new point with larger distance
...
if __name__ == '__main__':
    out = generate_possion_dis(100, 0.01, 0.99)
