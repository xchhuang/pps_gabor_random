...
class CNN(nn.Module):
    def __init__(self, opt, num_attributes=6):
        ...
        print('cnn num_attributes:', num_attributes)
        init_channel = 1 + 9 * num_attributes  # 18
    ...
    def encode(self, x):
        # print('normal_cnn_multiattributes.encode:', x.shape)
        outputs = []
        # outputs.append(x)
